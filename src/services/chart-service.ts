...
;                    yaxisFormat='{value:.'+p+'f}';
    ...
    static GenerateCapitalChart(CapitalData:any) {
        return new Promise((resolve, reject) => {
    ...
    static GenerateCapitalChartOld3(CapitalData:any, VolumeData:any) {
        return new Promise((resolve, reject) => {
            var MarketCap:any[] = [];
            var VolumeCap:any[] = [];
    ...
    static GenerateCapitalChartWorkingCap(CapitalData:any) {
        return new Promise((resolve, reject) => {
